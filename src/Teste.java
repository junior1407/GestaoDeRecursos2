...
public class Teste {
		...
		do {
			...
			case 1: {
				...
				if (getPosCpf(usuarios_cpf, cpf) == 1) {
					...
					contador_usuarios++;
					System.out.println("Cadastro de usu�rio conclu�do com sucesso!");
				} else {
			...
			case 2: {
				...
				System.out.println("Digite seu CPF");
				int cpf = scannerInt.nextInt();
				System.out.println("Digite o n�mero para qual tipo de sala voc� quer reservar"
						+ "; 0 - Sala de Aula, 1 - Audit�rio, 2 - Laborat�rio");
				...
				if ((tipo != 1) && (!isProfessor(usuarios_tipo, usuarios_cpf, cpf))) {
					...
					System.out.println("Qual o n�mero da sala que voc� deseja reservar?");
					...
					System.out.println("Digite o hora de �nicio da Reserva");
					...
					if (pos != -1) {
						...
						System.out.println("O c�digo da sua atividade e " + contador_atividades[tipo][sala]);
						salas_codigo[tipo][sala][pos] = contador_atividades[tipo][sala];
						contador_atividades[tipo][sala]++;

					} else {
						System.out.println("Hor�rio n�o disponivel");
					}
				}
				break;
			}
			...
			case 4: {
				System.out.println("=====Aloca��o de Recursos =====");
				System.out.println("Digite seu CPF");
				int cpf = scannerInt.nextInt();
				if ((!temPermissoes(usuarios_tipo, usuarios_cpf, cpf))) {
					System.out.println("Voce precisa ser Professor, Pesquisador ou Administrador do Sistema!!");
					...
					System.out.println("Voc� ja tem uma atividade em andamento!");
				} else {
					System.out.println("Digite: 0 - Sala de Aula, 1 - Audit�rio, 2 - Laborat�rio");
					int tipo = scannerInt.nextInt();
					...
					if (salas_cpfResp[tipo][sala][pos_atividade] == cpf) {
						...
						if (pos != -1) {
							...
							System.out.println("O recurso j� esta ocupado! ");
						}

					} else {
						System.out.println("Voce n�o e o responsavel pela atividade");
					}
			...
			case 7: {
				System.out.println("=====Altera��o Estados Recursos=====");
				...
				if (pos_atividade != -1) {
					...
					if (posicao_recurso_registro != -1) {
						...
						System.out.println("Parece que o recurso n�o foi encontrado");
					}
				} else {
					System.out.println("Parece que a atividade n�o foi achada");
				}
			...
			case 8: {
				...
				System.out.println("=====Inser��o uso do Recurso=====");
				System.out.println("Digite o seu CPF");
				int cpf = scannerInt.nextInt();
				int pos_usuario = getPosCpf(usuarios_cpf, cpf);
				System.out.println(" Digite: 0 - Sala de Aula, 1 - Audit�rio, 2 - Laborat�rio");
				...
				if (pos_atividade != -1) {
					...
					int posicao_recurso_registro = getIndex(recursos_codigoAtividade[pos_recurso], codigo_atividade,
							registro_recursos[pos_recurso]);
					if (recursos_cpf[pos_recurso][posicao_recurso_registro] == cpf) { // If vc � o responsavel
						if (posicao_recurso_registro != -1) {
							...
							System.out.println("Recurso n�o ligado a essa atividade");
						}
					} else {
						System.out.println("Voce n�o � o responsavel pela atividade");
					}
			...
			case 9: {
				System.out.println("=====Informa��es de Usuario=====");
				...
				case 1: {
					System.out.printf("Aluno de Gradua��o\n");
					break;
				}
				case 2: {
				...
				if (ja_locou == 0) {
					System.out.println("O usuario n�o alocou nenhum recurso.");
				}
			...
			case 10: {
				System.out.println("=====Informa��es de Recurso=====");
				System.out.println("Digite o codigo do recurso");
				int codigo_recurso = scannerInt.nextInt();
				System.out.printf("Identifica��o:  %s\n", recursos_iden[codigo_recurso]);
				...
				// Consulta por recurso. Dados do recurso, usuarios que j� botaram a mao.
				break;

			}
			case 11: {
				System.out.println("=====Relat�rio Completo=====");
				System.out.printf("Relat�rio Completo\nExistem %d usuarios.\n", contador_usuarios);
	...
	private static void showRecursosAlocados(int[][] recursos_codigoAtividade, String[] recursos_iden,
		...
		if (contador == 0) {
			System.out.println("N�o foram alocados recursos para essa atividade");
		}
